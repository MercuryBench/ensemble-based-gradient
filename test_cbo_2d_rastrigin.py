...
noise = "orthogonal" #vanilla, component, orthogonal
...
params["sig"] = 5.0 # coefficient of noise
params["kappa"] = 0*0.25 # coefficient of gradient drift term
params["avar"] = 0.0
...
for i in range(N-1):
    ...
    us_list[:,:,i+1] = step_gradCBO(us_list[:, :, i], Phi, params,tau=tau, maxstep="var", noise=noise)
