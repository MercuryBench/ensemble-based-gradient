...
ax1.pcolormesh(yedges, xedges, H.T); 
ax1.set_xlim((xmin,xmax));ax1.set_ylim((ymin,ymax))
ax1.contour(U0, U1, np.exp(-I(U)), 5, alpha=0.2, colors="white")
ax1.set_title("ELSa")

ax2.pcolormesh(yedges2, xedges2, H2.T); 
ax2.set_xlim((xmin,xmax));ax2.set_ylim((ymin,ymax))
ax2.contour(U0, U1, np.exp(-I(U)), 5, alpha=0.2, colors="white")
ax2.set_title("EMALA")

ax4.pcolormesh(yedges3, xedges3, H3.T); 
ax4.set_xlim((xmin,xmax));ax3.set_ylim((ymin,ymax))
ax4.contour(U0, U1, np.exp(-I(U)), 5, alpha=0.2, colors="white")
ax4.set_title("ALDI")

ax6.pcolormesh(yedges4, xedges4, H4.T); 
ax6.set_xlim((xmin,xmax));ax4.set_ylim((ymin,ymax))
ax6.contour(U0, U1, np.exp(-I(U)), 5, alpha=0.2, colors="white")
ax6.set_title("RWMH")

ax5.pcolormesh(yedges5, xedges5, H5.T); 
ax5.set_xlim((xmin,xmax));ax5.set_ylim((ymin,ymax))
ax5.contour(U0, U1, np.exp(-I(U)), 5, alpha=0.2, colors="white")
ax5.set_title("ALDI-est")

ax3.pcolormesh(yedges6, xedges6, H6.T); 
ax3.set_xlim((xmin,xmax));ax6.set_ylim((ymin,ymax))
ax3.contour(U0, U1, np.exp(-I(U)), 5, alpha=0.2, colors="white")
ax3.set_title("CBS")
...
plt.title("ELSa")
for i in range(J):
    plt.plot(us_list_burnin[1,i,:], alpha=alpha_op)
plt.subplot(4,3,2)
plt.title("EMALA")
for i in range(J):
...
plt.title("EMALA")
for i in range(J):
    plt.plot(us_list_MALA_burnin[1,i,:], alpha=alpha_op)
plt.subplot(4,3,7)
plt.title("ALDI")
for i in range(J):
...
plt.title("ALDI")
for i in range(J):
    plt.plot(us_list_ALDI_burnin[1,i,:], alpha=alpha_op)
plt.subplot(4,3,9)
plt.title("RWMH")
for i in range(J):
...
plt.title("RWMH")
for i in range(J):
    plt.plot(us_list_RWMH_burnin[1,i,:], alpha=alpha_op)
plt.subplot(4,3,8)
plt.title("ALDI-est")
for i in range(J):
...
plt.title("ALDI-est")
for i in range(J):
    plt.plot(us_list_augALDI_burnin[1,i,:], alpha=alpha_op)
plt.subplot(4,3,3)
plt.title("CBS")
for i in range(J):
...
plt.title("CBS")
for i in range(J):
    plt.plot(us_list_CBS_burnin[1,i,:], alpha=alpha_op)
plt.tight_layout()
...
plt.subplot(4,3,4)
plt.title("ELSa")
plt.hist(samples[1,:], bins=binsy, density=True)
plt.plot(u1s, marg_over_x)
plt.subplot(4,3,2)
plt.title("EMALA")
...
plt.subplot(4,3,5)
plt.title("EMALA")
plt.hist(samples_MALA[1,:], bins=binsy, density=True)
plt.plot(u1s, marg_over_x)
plt.subplot(4,3,7)
plt.title("ALDI")
...
plt.subplot(4,3,10)
plt.title("ALDI")
plt.hist(samples_ALDI[1,:], bins=binsy, density=True)
plt.plot(u1s, marg_over_x)
plt.subplot(4,3,9)
plt.title("RWMH")
...
plt.subplot(4,3,12)
plt.title("RWMH")
plt.hist(samples_RWMH[1,:], bins=binsy, density=True)
plt.plot(u1s, marg_over_x)
plt.subplot(4,3,8)
plt.title("ALDI-est")
...
plt.subplot(4,3,11)
plt.title("ALDI-est")
plt.hist(samples_augALDI[1,:], bins=binsy, density=True)
plt.plot(u1s, marg_over_x)
plt.subplot(4,3,3)
plt.title("CBS")
...
plt.subplot(4,3,6)
plt.title("CBS")
plt.hist(samples_CBS[1,:], bins=binsy, density=True)
plt.plot(u1s, marg_over_x)
plt.tight_layout()